...
<xsl:template name="t1">
  ...
  <xsl:for-each select="//x:file">
    <xsl:for-each select="x:body/x:group/x:trans-unit">
      <xsl:value-of select="'&quot;'"/>
      <xsl:value-of select="../../../@original"/>
      <xsl:value-of select="'&quot;&#9;&quot;'"/>
      <xsl:value-of select="@id"/>
      <xsl:value-of select="'&quot;&#9;&quot;'"/>
      <xsl:value-of select="str:replace(x:seg-source, '&quot;', '&quot;&quot;')"/>
      <xsl:value-of select="'&quot;&#9;&quot;'"/>
      <xsl:value-of select="str:replace(x:target, '&quot;', '&quot;&quot;')"/>
      <xsl:value-of select="'&quot;&#9;&quot;'"/>
      <xsl:value-of select="str:replace(sdl:seg-defs/sdl:seg/@locked, '&quot;', '&quot;&quot;')"/>
      <xsl:value-of select="'&quot;&#9;&quot;'"/>
      <xsl:value-of select="str:replace(sdl:seg-defs/sdl:seg/@id, '&quot;', '&quot;&quot;')"/>
      <xsl:value-of select="'&quot;&#9;&quot;'"/>
      <xsl:value-of select="str:replace(sdl:seg-defs/sdl:seg/@percent, '&quot;', '&quot;&quot;')"/>
      <xsl:value-of select="'&quot;&#9;&quot;'"/>
      <xsl:value-of select="str:replace(sdl:seg-defs/sdl:seg/@origin-system, '&quot;', '&quot;&quot;')"/>
      <xsl:value-of select="'&quot;'"/>
      <xsl:value-of select="'&#10;'"/>
    </xsl:for-each>
  </xsl:for-each>
